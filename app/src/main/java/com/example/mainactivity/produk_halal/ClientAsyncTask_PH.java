...
import com.example.mainactivity.jadwalsolat.ClientAsyncTask_JS;
...
public class ClientAsyncTask_PH extends AsyncTask<Void, Void, String> {
    ...
    public ClientAsyncTask_PH(Context mContext, String api_url, OnPostExecuteListener mPostExecuteListener){
